...
[Continue working on v0 →](https://v0.app/chat/projects/prj_AKgh2bx4JIquzt2XTGZpU4aU5hiD)
...
2. Conectar `www.bope.cl` en Settings → Domains
3. Volver a desplegar

Las referencias internas del sitio (canonical, sitemap, Open Graph) ya apuntan a
`https://www.bope.cl`.
